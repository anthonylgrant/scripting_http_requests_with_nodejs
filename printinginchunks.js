...
function getAndPrintHTMLChunks (hostname, pathname) {
...
var hostarg = 'sytantris.github.io'
var patharg = '/http-examples/step1.html'

getAndPrintHTMLChunks(hostarg, patharg);
